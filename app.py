...
from process import make_model
...
NUM_CLASSES = 10
mammals_classes = ["anoadataranrendah", "babirusasulawesi", "julangsulawesi", "kangkarengsulawesi", "kuskusberuang", 
                   "kuskuskerdil", "maleosenkawor", "musangsulawesi", "tangkasi", "yakisulawesi"]
...
def apiDeteksi():
	...
	if filename != '':
		...
		if file_ext in app.config['UPLOAD_EXTENSIONS']:
			...
			hasil_prediksi = mammals_classes[y_pred_test_classes_single[0]]
